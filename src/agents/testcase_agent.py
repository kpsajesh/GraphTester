...
# -here rich and loguru dependancies for logs in a better organised way
...
# 5. set OPENAI_API_KEY in .env variable ( This may not be required for Ollama, but just in case you want to test OpenAI also)
# $env:OPENAI_API_KEY="your_api_key_here" 
# 6. Check the Open AI API is set correctly
