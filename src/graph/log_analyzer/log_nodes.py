...
# Creating 5 nodes - read_logs, group_events, analyze_with_llm, create_jira_tickets, send_slack_summary


"""
Log Analyzer (LangGraph)
--------------------------------
...
from .log_state import LogAnalyzerState
