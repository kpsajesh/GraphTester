...
---------------------------------------
This file defines the individual node functions for the pipeline.
Each node updates the shared TestCaseState.
"""
...
ROOT = Path(__file__).resolve().parents[3] # Root folder is 3 levels above the current file
